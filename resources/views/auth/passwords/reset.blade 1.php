...
<div class="container">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form style="float: right"  method="POST" action="{{ route('password.update') }}">
                            @csrf
     ...
     --}}
                            <div class=" item form-group">                        
                                <div  class="input-group col-md-6  col-sm-6">
                                    ...
                                    <input style="width: 500px" id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
     ...
     --}}
                            <div class=" item form-group">                        
                                <div  class="input-group col-md-6  col-sm-6">
                                    <input style="width: 500px" id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" placeholder="{{ __('Password') }}">
                        ...
                        <div class="row mb-3">
                            <div class=" item form-group">                        
                                ...
                                {{-- <label for="password-confirm" class="col-md-4 col-form-label text-md-end">{{ __('Confirm Password') }}</label> --}}
                                        ...
                                        <input style="width: 500px" id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" placeholder="{{ __('Confirm Password') }}">
