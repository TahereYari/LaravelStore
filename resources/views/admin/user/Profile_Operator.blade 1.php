...
<div class="x_panel">
    ...
    <div class="x_content">
        ...
        <form style="margin-right: 20%" id="demo-form2" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left" action="{{ route('user_edit')}}">
        ...
        <div class="row">
            <div class="col-md-12  item form-group">
                <div class="input-group col-md-6  col-sm-6">
                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" value="{{ __('Current Password') }}"  placeholder="رمز عبور" required autocomplete="new-password">
            ...
            <div class="col-md-12 item form-group">
                <div class="input-group col-md-6  col-sm-6">
                    <input id="password-confirm" type="password" class="form-control" name="password_confirmation" value="{{ __('Current Password') }}" placeholder="تکرار رمز عبور" required autocomplete="new-password">
                </div>
            </div>
            <div class="col-md-12  item form-group">
            ...
            <div class="col-md-12  item form-group">
                ...
                <img width="100" height="100" src="{{ asset('image/'.Auth::user()->image) }}" alt="">
                  ...
                  <input i type="hidden" class="form-control" name="id" value="{{ Auth::user()->id }}" placeholder="تکرار رمز عبور" required autocomplete="new-password">
