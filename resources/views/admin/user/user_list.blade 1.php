...
{{-- //****************************************************** --}}
    ...
    <div class="x_panel">
      ...
      <div class="row" style="margin: 3%">
        <a href="{{ route('user_create') }}" class="btn btn-round btn-primary">افزودن کاربر جدید</a>
      </div>
      <div class="table-responsive">
        <table id="datatable-buttons" class="table email-table no-wrap table-hover v-middle mb-0 font-14" style="width: 100%;"  aria-describedby="datatable-buttons_info">
            ...
            <tr role="row">
              ...
              <th class="sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 115px;" aria-sort="ascending" aria-label="Name: activate to sort column descending">نام کاربری</th>
              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 178px;" aria-label="Position: activate to sort column ascending">ایمیل</th>
              <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 178px;" aria-label="Position: activate to sort column ascending">نوع دسترسی</th>
