        ...
        <form  id="demo-form2" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left" action="{{ route('store-insert') }}">
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <input type="text" id="name" name="name"  class="form-control " placeholder="نام فروشگاه">
                </div>
            </div>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <input type="text" id="phone" name="phone"  class="form-control "  onkeyup="javascript:this.value=separate(this.value);" placeholder="تلفن">
                </div>
            </div>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input id="name" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="ایمیل" name="email"  required autocomplete="email">
                </div>
                @error('email')
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <input type="text"  name="instagram"  class="form-control " placeholder=" آدرس اینستاگرام">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <input type="text" id="name" name="telgram"  class="form-control " placeholder=" آدرس تلگرام ">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <input type="text" id="name" name="address"  class="form-control " placeholder=" آدرس فروشگاه ">
                </div>
            </div>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <textarea class="form-control" rows="3" id="tiny" name="describe" placeholder=" توضیحات..."></textarea>
                </div>
            </div>
