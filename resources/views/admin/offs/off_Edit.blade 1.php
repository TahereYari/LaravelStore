            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="{{ route('admin') }}"><i class="fa fa-home"></i> صفحه اصلی </a>
    ...
    <div class="x_content">
        ...
        <form   data-parsley-validate="" enctype="multipart/form-data" method="POST" class="contact-form form-horizontal form-label-left" novalidate="" action="{{ route('off-insert') }}">
            ...
            <div class="item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">نام محصول 
                </label>
                <select name="product" style="width: 50%" class="form-control">
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6">
                    <input type="number" id="offprice" name="offprice"  class="form-control " placeholder=" میزان تخفیف" value="{{ $discount->off }}">
                </div>
