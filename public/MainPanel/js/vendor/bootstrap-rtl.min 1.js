    ...
    +(function (a) {
        ...
        (c.VERSION = "3.3.1"),
            ...
            (c.prototype.setScrollbar = function () {
                ...
                this.bodyIsOverflowing && this.$body.css("padding-left", a + this.scrollbarWidth);
            }),
            (c.prototype.resetScrollbar = function () {
                this.$body.css("padding-left", "");
            }),
    ...
    +(function (a) {
        ...
        (c.VERSION = "3.3.1"),
            ...
            (c.prototype.show = function () {
                ...
                if (this.hasContent() && this.enabled) {
                    ...
                    if (j) {
                        ...
                        (h = "bottom" == h && k.bottom + m > p.bottom ? "top" : "top" == h && k.top - m < p.top ? "bottom" : "left" == h && k.left + l > p.width ? "right" : "right" == h && k.right - l < p.right ? "left" : h),
            ...
            (c.prototype.applyPlacement = function (b, c) {
                ...
                isNaN(g) && (g = 0),
                    ...
                    a.offset.setOffset(
                        ...
                        a.extend(
                            {
                                using: function (a) {
                                    d.css({ top: Math.round(a.top), right: Math.round(a.left) });
                                },
                            },
                            b
                        ),
                ...
                k.right ? (b.right += k.left) : (b.top += k.top);
                var l = /top|bottom/.test(c),
                    m = l ? 2 * k.right - e + i : 2 * k.top - f + j,
                    n = l ? "offsetWidth" : "offsetHeight";
                d.offset(b), this.replaceArrow(m, d[0][n], l);
            }),
            (c.prototype.replaceArrow = function (a, b, c) {
                this.arrow()
                    .css(c ? "right" : "top", 50 * (1 - a / b) + "%")
                    .css(c ? "top" : "right", "");
            }),
            (c.prototype.setContent = function () {
                var a = this.tip(),
                    b = this.getTitle();
                a.find(".tooltip-inner")[this.options.html ? "html" : "text"](b), a.removeClass("fade in top bottom right right");
            }),
            (c.prototype.hide = function (b) {
                function d() {
            ...
            (c.prototype.getPosition = function (b) {
                ...
                null == e.width && (e = a.extend({}, e, { width: e.left - e.right, height: e.bottom - e.top }));
                var f = d ? { top: 0, right: 0 } : b.offset(),
            ...
            (c.prototype.getCalculatedOffset = function (a, b, c, d) {
                return "bottom" == a
                    ? { top: b.top + b.height, right: b.right + b.width / 2 - c / 2 }
                    : "top" == a
                    ? { top: b.top - d, right: b.right + b.width / 2 - c / 2 }
                    : "right" == a
                    ? { top: b.top + b.height / 2 - d / 2, right: b.right - c }
                    : { top: b.top + b.height / 2 - d / 2, right: b.right + b.width };
            }),
            (c.prototype.getViewportAdjustedDelta = function (a, b, c, d) {
                ...
                if (/left|right/.test(a)) {
                    ...
                    var j = b.right - f,
                        k = b.right + f + c;
                    j < g.right ? (e.right = g.right - j) : k > g.width && (e.right = g.right + g.width - k);
                }
                return e;
            }),
        ...
        (c.VERSION = "3.3.1"),
            ...
            (c.prototype.setContent = function () {
                ...
                a.find(".popover-title")[this.options.html ? "html" : "text"](b),
                    ...
                    a.removeClass("fade top bottom right left in"),
