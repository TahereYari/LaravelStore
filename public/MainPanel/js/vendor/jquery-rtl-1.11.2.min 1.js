...
!(function (a, b) {
        ...
        m(function () {
            ...
            (c = y.getElementsByTagName("body")[0]),
                c &&
                    ...
                    (d.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;right:-9999px"),
        ...
        : y.documentElement.currentStyle &&
          ...
          (Jb = function (a, b, c) {
              ...
              return (
                  ...
                  Hb.test(g) &&
                      !Kb.test(b) &&
                      ((d = h.right), (e = a.runtimeStyle), (f = e && e.right), f && (e.left = a.currentStyle.left), (h.right = "fontSize" === b ? "1em" : g), (g = h.pixelLeft + "px"), (h.right = d), f && (e.left = f)),
                  void 0 === g ? g : g + "" || "auto"
              );
          }));
    function Lb(a, b) {
    ...
    !(function () {
        ...
        if (((b = y.createElement("div")), (b.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"), (d = b.getElementsByTagName("a")[0]), (c = d && d.style))) {
            (c.cssText = "float:right;opacity:.5"),
    ...
    (m.offset = {
        setOffset: function (a, b, c) {
            ...
            "static" === k && (a.style.position = "relative"),
                ...
                null != b.right && (n.left = b.left - h.left + e),
                    ...
                    return (
                        ...
                        m.contains(b, e)
                            ? (typeof e.getBoundingClientRect !== K && (d = e.getBoundingClientRect()),
                              (c = dd(f)),
                              { top: d.top + (c.pageYOffset || b.scrollTop) - (b.clientTop || 0), right: d.right + (c.pageXOffset || b.scrollLeft) - (b.clientLeft || 0) })
                            : d
                    );
            },
            position: function () {
                if (this[0]) {
                    ...
                    return (
                        "fixed" === m.css(d, "position")
                            ...
                            : ((a = this.offsetParent()), (b = this.offset()), m.nodeName(a[0], "html") || (c = a.offset()), (c.top += m.css(a[0], "borderTopWidth", !0)), (c.right += m.css(a[0], "borderLeftWidth", !0))),
                        { top: b.top - c.top - m.css(d, "marginTop", !0), right: b.right - c.right - m.css(d, "marginLeft", !0) }
                    );
                }
            },
