...
(function (f, g, k) {
    var l = {
        ...
        appendWrapperSizes: function () {
            this.$owlWrapper.css({ width: this.$owlItems.length * this.itemWidth * 2, right: 0 });
        ...
        gestures: function () {
            ...
            d.$elem.on(d.ev_types.start, ".owl-wrapper", function (c) {
                ...
                if (!(d.itemsAmount <= d.options.items)) {
                    ...
                    e = f(this).position();
                    h.relativePos = e.right;
                    h.offsetX = a(c).x - e.right;
        ...
        closestItem: function () {
            ...
            f.each(b, function (d, g) {
                e - a.itemWidth / 20 > b[d + 1] && e - a.itemWidth / 20 < g && "right" === a.moveDirection()
        ...
        singleItemTransition: function () {
            ...
            d.css({ position: "relative", right: f + "px" })
                .addClass(b)
        ...
        clearTransStyle: function (a, b) {
            a.css({ position: "", right: "" }).removeClass(b);
