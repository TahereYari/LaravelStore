...
function init_sidebar() {
    function t() {
        ...
        var e = $BODY.outerHeight(),
            ...
            t = $right_COL.eq(1).height() + $SIDEBAR_FOOTER.height(),
            o = e < t ? t : e;
        (o -= $NAV_MENU.height() + a), $left_COL.css("min-height", o);
    }
    function o() {
        ...
        $("#chart_plot_01").length &&
            ...
            $("#chart_plot_03").length &&
                ...
                $.plot(
                    ...
                    { series: { curvedLines: { apply: !0, active: !0, monotonicFit: !0 } }, colors: ["#26B99A"], grid: { borderWidth: { top: 0, left: 0, bottom: 1, right: 1 }, borderColor: { bottom: "#7F8790", right: "#7F8790" } } }
                ));
    }
}
...
function init_daterangepicker_right() {
    if (void 0 !== $.fn.daterangepicker) {
        ...
        function e(e, a, t) {
            console.log(e.toISOString(), a.toISOString(), t), $("#reportrange_left span").html(e.format("MMMM D, YYYY") + " - " + a.format("MMMM D, YYYY"));
        }
        var a = {
            startDate: moment().subtract(29, "days"),
            endDate: moment(),
        ...
        $("#reportrange_left span").html(moment().subtract(29, "days").format("MMMM D, YYYY") + " - " + moment().format("MMMM D, YYYY")),
    ...
    if (void 0 !== $.fn.fullCalendar) {
        ...
        var o,
            ...
            i = $("#calendar").fullCalendar({
                header: { right: "prev,next today", center: "title", left: "month,agendaWeek,agendaDay,listMonth" },
                selectable: !0,
                selectHelper: !0,
    ...
    if ("undefined" != typeof echarts) {
        ...
        if ($("#echart_pyramid").length)
            echarts.init(document.getElementById("echart_pyramid"), e).setOption({
                ...
                toolbox: { show: !0, feature: { restore: { show: !0, title: "Restore" }, saveAsImage: { show: !0, title: "Save Image" } } },
                legend: { data: ["Something #1", "Something #2", "Something #3", "Something #4", "Something #5"], orient: "vertical", x: "right", y: "bottom" },
                calculable: !0,
                series: [
                    {
                        name: "漏斗图",
        ...
        if ($("#echart_pie").length) {
            echarts.init(document.getElementById("echart_pie"), e).setOption({
                ...
                toolbox: {
                    show: !0,
                    feature: {
                        magicType: { show: !0, type: ["pie", "funnel"], option: { funnel: { x: "25%", width: "50%", funnelAlign: "right", max: 1548 } } },
                        restore: { show: !0, title: "Restore" },
                        saveAsImage: { show: !0, title: "Save Image" },
                    },
                },
